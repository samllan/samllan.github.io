...
class _ProjectGridState extends State<ProjectGrid> {
  List<Project> projects = const [
    Project('Computer Vision - Tuberculosis Quantification', 'assets/ST_A_bacteria_fluorescent.jpg', 'https://yourusername.github.io/project1'),
    ...
    Project('LLM - What Matters To You?', 'assets/heart question mark.webp', 'https://yourusername.github.io/project4'),
    ...
    Project('Galactic Signal Mapping - Durham Radio Telescope', 'assets/DRT_pexels-philippedonn-1169754.jpg', 'https://yourusername.github.io/project8'),
    Project('Founder - AI Society', 'assets/AI at Leeds Logo.png', 'https://yourusername.github.io/project9'),
    Project('Founder - AI^2 Society', 'assets/ai2 logo.png', 'https://yourusername.github.io/project10'),
    Project('Design - Strathclyde Engineering', 'assets/strathclyde boat bulding.jpg', 'https://yourusername.github.io/project11'),
